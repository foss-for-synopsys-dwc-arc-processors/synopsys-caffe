...
#include "caffe/layers/detection_subgraph_layer.hpp"

namespace caffe {

template <typename Dtype>
void DetectionSubgraphLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void DetectionSubgraphLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
  if (need_save_) {
...
template <typename Dtype>
void DetectionSubgraphLayer<Dtype>::Forward_cpu(
...
INSTANTIATE_CLASS(DetectionSubgraphLayer);
REGISTER_LAYER_CLASS(DetectionSubgraph);
