...
#include "caffe/layers/ssd_sort_layer.hpp"

namespace caffe {

template <typename Dtype>
void SSDSortLayer<Dtype>::LayerSetUp(const vector<Blob<Dtype>*>& bottom,
...
template <typename Dtype>
void SSDSortLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top) {
...
template <typename Dtype>
void SSDSortLayer<Dtype>::Forward_cpu(
  ...
  GetLocPredictions(bbox_data, num, num_priors_, num_loc_classes_,
...
INSTANTIATE_CLASS(SSDSortLayer);
REGISTER_LAYER_CLASS(SSDSort);
