...
echo "if [ -z \"\${SYNOPSYS_CAFFE_HOME}\" ] ; then" > env.sh
echo "    export SYNOPSYS_CAFFE_HOME=\$(readlink -f \$(dirname \${BASH_SOURCE[0]}))" >> env.sh
echo "fi" >> env.sh
echo "export BINDIR=\"\$SYNOPSYS_CAFFE_HOME/bin\"" >> env.sh
echo "export BINLIBDEST=\"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.sh
echo "export BLDSHARED=\"gcc -pthread -shared -L\$SYNOPSYS_CAFFE_HOME/lib -L\$SYNOPSYS_CAFFE_HOME/lib64 -ldl\"" >> env.sh
echo "export CFLAGS=\"-I\$SYNOPSYS_CAFFE_HOME/include -I\$SYNOPSYS_CAFFE_HOME/include/python3.8 -I\$SYNOPSYS_CAFFE_HOME/lib/python3.8/site-packages/numpy/core/include -fPIC\"" >> env.sh
echo "export CPLUS_INCLUDE_PATH=\"\$SYNOPSYS_CAFFE_HOME/include/python3.8\"" >> env.sh
echo "export CXXFLAGS=\"\$CFLAGS -std=c++11\"" >> env.sh
echo "export CONFINCLUDEDIR=\"\$SYNOPSYS_CAFFE_HOME/include\"" >> env.sh
echo "export CONFINCLUDEPY=\"\$SYNOPSYS_CAFFE_HOME/include/python3.8\"" >> env.sh
echo "export DESTDIRS=\"\$SYNOPSYS_CAFFE_HOME \$SYNOPSYS_CAFFE_HOME/lib \$SYNOPSYS_CAFFE_HOME/lib/python3.8 \$SYNOPSYS_CAFFE_HOME/lib/python3.8/lib-dynload\"" >> env.sh
echo "export DESTLIB=\"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.sh
echo "export DESTSHARED=\"\$SYNOPSYS_CAFFE_HOME/lib/python3.8/lib-dynload\"" >> env.sh
echo "export INCLDIRSTOMAKE=\"\$SYNOPSYS_CAFFE_HOME/include \$SYNOPSYS_CAFFE_HOME/include \$SYNOPSYS_CAFFE_HOME/include/python3.8 \$SYNOPSYS_CAFFE_HOME/include/python3.8\"" >> env.sh
echo "export INCLUDEDIR=\"\$SYNOPSYS_CAFFE_HOME/include\"" >> env.sh
echo "export INCLUDEPY=\"\$SYNOPSYS_CAFFE_HOME/include/python3.8\"" >> env.sh
echo "export LDFLAGS=\"-L\$SYNOPSYS_CAFFE_HOME/lib -L\$SYNOPSYS_CAFFE_HOME/lib64 -ldl\"" >> env.sh
echo "export LDSHARED=\"gcc -pthread -shared -L\$SYNOPSYS_CAFFE_HOME/lib -L\$SYNOPSYS_CAFFE_HOME/lib64 -ldl\"" >> env.sh
echo "export LIBDEST=\"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.sh
echo "export LIBDIR=\"\$SYNOPSYS_CAFFE_HOME/lib\"" >> env.sh
echo "export LIBP=\"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.sh
echo "export LIBPC=\"\$SYNOPSYS_CAFFE_HOME/lib/pkgconfig\"" >> env.sh
echo "export LIBPL=\"\$SYNOPSYS_CAFFE_HOME/lib/python3.8/config\"" >> env.sh
echo "export MACHDESTLIB=\"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.sh
echo "export MANDIR=\"\$SYNOPSYS_CAFFE_HOME/share/man\"" >> env.sh
echo "export PY_CFLAGS=\"-I\$SYNOPSYS_CAFFE_HOME/include -I\$SYNOPSYS_CAFFE_HOME/include/python3.8 -I\$SYNOPSYS_CAFFE_HOME/lib/python3.8/site-packages/numpy/core/include -fPIC\"" >> env.sh
...
echo "    if grep -qE '^(VERSION_ID)=\"8|^VERSION_ID=\"9' /etc/os-release; then" >> env.sh
echo "        export LD_LIBRARY_PATH=\"\$SYNOPSYS_CAFFE_HOME/lib_for_ubuntu2:\$LD_LIBRARY_PATH\"" >> env.sh
echo "    fi" >> env.sh
echo "else" >> env.sh
echo "    export LD_LIBRARY_PATH=\"\$SYNOPSYS_CAFFE_HOME/lib:\$SYNOPSYS_CAFFE_HOME/lib64:\$SYNOPSYS_CAFFE_HOME/lib_for_ubuntu2:\$LD_LIBRARY_PATH\"" >> env.sh
echo "fi" >> env.sh
...
echo "endif" >> env.csh
echo "set called=(\$_)" >> env.csh
echo "if ( \"\$called\" != \"\" ) then  # called by source" >> env.csh
echo "    set script_fn=\`readlink -f \$called[2]\`" >> env.csh
echo "else  # called by direct excution of the script" >> env.csh
echo "    set script_fn=\`readlink -f \$0\`" >> env.csh
echo "endif" >> env.csh
echo "setenv SYNOPSYS_CAFFE_HOME \`dirname \$script_fn\`" >> env.csh
echo "setenv BINDIR \"\$SYNOPSYS_CAFFE_HOME/bin\"" >> env.csh
echo "setenv BINLIBDEST \"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.csh
echo "setenv BLDSHARED \"gcc -pthread -shared -L\$SYNOPSYS_CAFFE_HOME/lib -L\$SYNOPSYS_CAFFE_HOME/lib64 -ldl\"" >> env.csh
echo "setenv CFLAGS \"-I\$SYNOPSYS_CAFFE_HOME/include -I\$SYNOPSYS_CAFFE_HOME/include/python3.8 -I\$SYNOPSYS_CAFFE_HOME/lib/python3.8/site-packages/numpy/core/include -fPIC\"" >> env.csh
echo "setenv CPLUS_INCLUDE_PATH \"\$SYNOPSYS_CAFFE_HOME/include/python3.8\"" >> env.csh
echo "setenv CXXFLAGS \"\$CFLAGS -std=c++11\"" >> env.csh
echo "setenv CONFINCLUDEDIR \"\$SYNOPSYS_CAFFE_HOME/include\"" >> env.csh
echo "setenv CONFINCLUDEPY \"\$SYNOPSYS_CAFFE_HOME/include/python3.8\"" >> env.csh
echo "setenv DESTDIRS \"\$SYNOPSYS_CAFFE_HOME \$SYNOPSYS_CAFFE_HOME/lib \$SYNOPSYS_CAFFE_HOME/lib/python3.8 \$SYNOPSYS_CAFFE_HOME/lib/python3.8/lib-dynload\"" >> env.csh
echo "setenv DESTLIB \"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.csh
echo "setenv DESTSHARED \"\$SYNOPSYS_CAFFE_HOME/lib/python3.8/lib-dynload\"" >> env.csh
echo "setenv INCLDIRSTOMAKE \"\$SYNOPSYS_CAFFE_HOME/include \$SYNOPSYS_CAFFE_HOME/include \$SYNOPSYS_CAFFE_HOME/include/python3.8 \$SYNOPSYS_CAFFE_HOME/include/python3.8\"" >> env.csh
echo "setenv INCLUDEDIR \"\$SYNOPSYS_CAFFE_HOME/include\"" >> env.csh
echo "setenv INCLUDEPY \"\$SYNOPSYS_CAFFE_HOME/include/python3.8\"" >> env.csh
echo "setenv LDFLAGS \"-L\$SYNOPSYS_CAFFE_HOME/lib -L\$SYNOPSYS_CAFFE_HOME/lib64 -ldl\"" >> env.csh
echo "setenv LDSHARED \"gcc -pthread -shared -L\$SYNOPSYS_CAFFE_HOME/lib -L\$SYNOPSYS_CAFFE_HOME/lib64 -ldl\"" >> env.csh
echo "setenv LIBDEST \"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.csh
echo "setenv LIBDIR \"\$SYNOPSYS_CAFFE_HOME/lib\"" >> env.csh
echo "setenv LIBP \"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.csh
echo "setenv LIBPC \"\$SYNOPSYS_CAFFE_HOME/lib/pkgconfig\"" >> env.csh
echo "setenv LIBPL \"\$SYNOPSYS_CAFFE_HOME/lib/python3.8/config\"" >> env.csh
echo "setenv MACHDESTLIB \"\$SYNOPSYS_CAFFE_HOME/lib/python3.8\"" >> env.csh
echo "setenv MANDIR \"\$SYNOPSYS_CAFFE_HOME/share/man\"" >> env.csh
echo "setenv PY_CFLAGS \"-I\$SYNOPSYS_CAFFE_HOME/include -I\$SYNOPSYS_CAFFE_HOME/include/python3.8 -I\$SYNOPSYS_CAFFE_HOME/lib/python3.8/site-packages/numpy/core/include -fPIC\"" >> env.csh
...
echo "    if (grep -qE '^(VERSION_ID)=\"8|^VERSION_ID=\"9' /etc/os-release) then" >> env.csh
echo "        setenv LD_LIBRARY_PATH \"\$SYNOPSYS_CAFFE_HOME/lib_for_ubuntu2:\$LD_LIBRARY_PATH\"" >> env.csh
echo "    endif" >> env.csh
echo "else" >> env.csh
echo "    setenv LD_LIBRARY_PATH \"\$SYNOPSYS_CAFFE_HOME/lib:\$SYNOPSYS_CAFFE_HOME/lib64:\$SYNOPSYS_CAFFE_HOME/lib_for_ubuntu2:\$LD_LIBRARY_PATH\"" >> env.csh
echo "endif" >> env.csh
...
if [ ! -f distro/tcl.tar.gz ]; then
    wget -O distro/tcl.tar.gz https://prdownloads.sourceforge.net/tcl/tcl8.6.12-src.tar.gz --no-check-certificate
fi
tar zxf distro/tcl.tar.gz -C build
cd build/tcl8.6.12/unix
...
if [ ! -f distro/tk.tar.gz ]; then
    wget -O distro/tk.tar.gz https://prdownloads.sourceforge.net/tcl/tk8.6.12-src.tar.gz --no-check-certificate
fi
tar zxf distro/tk.tar.gz -C build
cd build/tk8.6.12/unix
./configure --prefix=$SYNOPSYS_CAFFE_HOME
make
make install
cd ../../..
...
# OpenSSL
if [ ! -f distro/openssl.tar.gz ]; then
    # wget -O distro/openssl.tar.gz https://www.openssl.org/source/old/1.0.2/openssl-1.0.2u.tar.gz --no-check-certificate
    wget -O distro/openssl.tar.gz https://github.com/openssl/openssl/archive/refs/tags/OpenSSL_1_0_2u.tar.gz --no-check-certificate
    # Note: tried to update to 1.1.1s but system's Perl version is lower than required
fi
tar -xzvf distro/openssl.tar.gz -C build
# cd build/openssl-1.0.2u
cd build/openssl-OpenSSL_1_0_2u
./config shared --prefix=$SYNOPSYS_CAFFE_HOME  # --openssldir=$SYNOPSYS_CAFFE_HOME/openssl
make  # don't use -j4, otherwise errors!
make install  # make install_sw  # use "make install" would raise error in doc install, so skip it
export CPPFLAGS+="-I$SYNOPSYS_CAFFE_HOME/include/openssl"
cd ../..

if [ ! -f distro/Python-3.8.16.tgz ]; then
    wget -O distro/Python-3.8.16.tgz https://www.python.org/ftp/python/3.8.16/Python-3.8.16.tgz --no-check-certificate
fi
tar zxf distro/Python-3.8.16.tgz -C build
cd build/Python-3.8.16
./configure --prefix=$SYNOPSYS_CAFFE_HOME --enable-shared --with-ensurepip=install --enable-unicode=ucs4 --with-tcltk-includes="-I${SYNOPSYS_CAFFE_HOME}/include" --with-tcltk-libs="-L${SYNOPSYS_CAFFE_HOME}/lib -ltcl8.6 -ltk8.6"
make
make install
cd ../..
...
if [ ! -f distro/protobuf.tar.gz ]; then
    wget -O distro/protobuf.tar.gz https://github.com/protocolbuffers/protobuf/releases/download/v3.19.6/protobuf-cpp-3.19.6.tar.gz --no-check-certificate
fi
tar -vzxf distro/protobuf.tar.gz -C build
cd build/protobuf-3.19.6
./configure --prefix=$SYNOPSYS_CAFFE_HOME
make
make install
cd ../..
...
if [ ! -f distro/boost.tar.gz ]; then
    # wget -O distro/boost.tar.gz https://boostorg.jfrog.io/artifactory/main/release/1.74.0/source/boost_1_74_0.tar.gz --no-check-certificate
    wget -O distro/boost.tar.gz https://sourceforge.net/projects/boost/files/boost/1.74.0/boost_1_74_0.tar.gz --no-check-certificate
fi
tar zxf distro/boost.tar.gz -C build
cd build/boost_1_74_0
...
if [ ! -f distro/gflags.tar.gz ]; then
    wget -O distro/gflags.tar.gz https://github.com/gflags/gflags/archive/refs/tags/v2.2.2.tar.gz --no-check-certificate
fi
tar zxf distro/gflags.tar.gz -C build
cd build/gflags-2.2.2
mkdir result
cd result
cmake -DCMAKE_INSTALL_PREFIX=$SYNOPSYS_CAFFE_HOME -DCMAKE_CXX_FLAGS:STRING=-fPIC -DBUILD_SHARED_LIBS=ON ..
make
make install
cd ../../..
...
if [ ! -f distro/glog.tar.gz ]; then
    wget -O distro/glog.tar.gz https://github.com/google/glog/archive/refs/tags/v0.4.0.tar.gz --no-check-certificate
    # Note: tried 0.6.0 but the configure structure has big changes; need further adjustment for build configure
fi
tar zxf distro/glog.tar.gz -C build
cd build/glog-0.4.0
#. autogen.sh  # only version >= 0.4.0 might need this
autoreconf -i  # avoid run "set -eu" in autogen.sh
./configure --prefix=$SYNOPSYS_CAFFE_HOME
make
make install
cd ../..
...
if [ ! -f distro/openblas.tar.gz ]; then
    wget -O distro/openblas.tar.gz https://github.com/xianyi/OpenBLAS/archive/refs/tags/v0.3.9.tar.gz --no-check-certificate
fi
tar zxf distro/openblas.tar.gz -C build
cd build/OpenBLAS-0.3.9
make TARGET=NEHALEM
make PREFIX=$SYNOPSYS_CAFFE_HOME TARGET=NEHALEM install
cd ../..
...
mkdir result
cd result
cmake -D CMAKE_BUILD_TYPE=RELEASE -D CMAKE_INSTALL_PREFIX=$SYNOPSYS_CAFFE_HOME -D WITH_CUDA=OFF -D WITH_CUFFT=OFF -D WITH_QT=OFF -D WITH_GTK=OFF -D BUILD_opencv_java=OFF ..
make
make install
cd ../../..
...
echo "+PYTHON_LIBRARIES := boost_python38 python3.8" >> Makefile.config.patch
echo "+PYTHON_INCLUDE := \$(SYNOPSYS_CAFFE_HOME)/include/python3.8 \\" >> Makefile.config.patch
echo "+                 \$(SYNOPSYS_CAFFE_HOME)/lib/python3.8/site-packages/numpy/core/include" >> Makefile.config.patch
echo " " >> Makefile.config.patch
...
pip3 install scikit-learn==0.24.2  # sklearn is deprecated
pip3 install imageio==2.15.0  # try to solve accuracy issue caused by scikit-image https://github.com/scikit-image/scikit-image/pull/6344/files
pip3 install future
pip3 install sympy
...
pip3 install dash
pip3 install psutil
pip3 install numpy==1.23.0  # to make onnx and tf compatible

pip3 install protobuf==3.19.6

pip3 install --global-option=build_ext --global-option="-I/usr/include/graphviz" --global-option="-L/usr/lib64/graphviz" pygraphviz
...
export NVCCFLAGS="-I$SYNOPSYS_CAFFE_HOME/include -I$SYNOPSYS_CAFFE_HOME/include/python3.8 -I$SYNOPSYS_CAFFE_HOME/lib/python3.8/site-packages/numpy/core/include"
