...
if [ ! -f distro/tcl.tar.gz ]; then
    wget -O distro/tcl.tar.gz https://prdownloads.sourceforge.net/tcl/tcl8.6.12-src.tar.gz
fi
...
if [ ! -f distro/tk.tar.gz ]; then
    wget -O distro/tk.tar.gz https://prdownloads.sourceforge.net/tcl/tk8.6.12-src.tar.gz
fi
...
if [ ! -f distro/Python-3.8.16.tgz ]; then
    wget -O distro/Python-3.8.16.tgz https://www.python.org/ftp/python/3.8.16/Python-3.8.16.tgz
fi
...
if [ ! -f distro/protobuf.tar.gz ]; then
    wget -O distro/protobuf.tar.gz https://github.com/protocolbuffers/protobuf/releases/download/v3.19.6/protobuf-cpp-3.19.6.tar.gz
fi
...
if [ ! -f distro/boost.tar.gz ]; then
    wget -O distro/boost.tar.gz https://sourceforge.net/projects/boost/files/boost/1.74.0/boost_1_74_0.tar.gz
fi
...
if [ ! -f distro/gflags.tar.gz ]; then
    wget -O distro/gflags.tar.gz https://github.com/gflags/gflags/archive/refs/tags/v2.2.2.tar.gz
fi
...
if [ ! -f distro/glog.tar.gz ]; then
    wget -O distro/glog.tar.gz https://github.com/google/glog/archive/refs/tags/v0.4.0.tar.gz
...
if [ ! -f distro/openblas.tar.gz ]; then
    wget -O distro/openblas.tar.gz https://github.com/xianyi/OpenBLAS/archive/refs/tags/v0.3.9.tar.gz
fi
