...
if(USE_HDF5)
  ...
  include_directories(SYSTEM ${HDF5_INCLUDE_DIRS} ${HDF5_HL_INCLUDE_DIRS})
  list(APPEND Caffe_INCLUDE_DIRS PUBLIC ${HDF5_INCLUDE_DIRS})
  list(APPEND Caffe_LINKER_LIBS ${HDF5_LIBRARIES} ${HDF5_HL_LIBRARIES})
  
  MESSAGE(STATUS "Found HDF5_INCLUDE_DIRS Path : ${HDF5_INCLUDE_DIRS}")
  MESSAGE(STATUS "Found HDF5_HL_INCLUDE_DIR Path : ${HDF5_HL_INCLUDE_DIRS}")  
  MESSAGE(STATUS "Found HDF5_LIBRARIES Path : ${HDF5_LIBRARIES}")
  MESSAGE(STATUS "Found HDF5_HL_LIBRARIES Path : ${HDF5_HL_LIBRARIES}")
  MESSAGE(STATUS "Found HDF5_hdf5_LIBRARY Path : ${HDF5_hdf5_LIBRARY}")
...
# ---[ Boost
find_package(Boost REQUIRED COMPONENTS  python3.${Python3_VERSION_MINOR}  system thread filesystem regex)
