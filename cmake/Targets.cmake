...
macro(caffe_set_caffe_link)  
  ...
  if(BUILD_SHARED_LIBS)
    ...
    elseif(MSVC)
      message("Justin hack for caffe.lib generation")
      set(Caffe_LINK "C:/vcpkg/installed/x64-windows-static/lib",caffe)
      set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} C:/vcpkg/installed/x64-windows-static/lib ")
      # set(CMAKE_EXE_LINKER_FLAGS "C:/vcpkg/installed/x64-windows-static/lib",C:/vcpkg/installed/x64-windows-static/lib)
    endif()
  endif()
endmacro()
################################################################################################
