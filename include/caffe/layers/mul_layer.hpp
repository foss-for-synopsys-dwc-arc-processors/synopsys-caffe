...
/*
 * @brief Compute elementwise mul. Support broadcasting as numpy and TensorFlow do.
 *
...
class MulLayer : public Layer<Dtype> {
 public:
  explicit MulLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
