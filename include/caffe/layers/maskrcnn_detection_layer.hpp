...
// implement of https://github.com/matterport/Mask_RCNN/blob/3deaec5d902d16e1daf56b62d5971d428dc920bc/mrcnn/model.py#L782

template <typename Dtype>
class MaskrcnnDetectionLayer : public Layer<Dtype> {
 public:
 ...
 protected:
  ...
  inline vector<int> tf_nms(vector<vector<Dtype> > &pred_boxes, vector<int> &order, int topk, float iou_threshold) const;
