...
class SmoothL1LossLayer : public LossLayer<Dtype> {
 public:
  ...
  virtual inline int ExactNumBottomBlobs() const { return -1; } //Faster RCNN
  virtual inline int MinBottomBlobs() const { return 2; }
  //virtual inline int MaxBottomBlobs() const { return 3; } //SSD
  virtual inline int MaxBottomBlobs() const { return 4; } //Faster RCNN
