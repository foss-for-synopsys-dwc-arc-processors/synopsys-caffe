#ifndef CAFFE_DETECTION_SUBGRAPH_LAYER_HPP_
#define CAFFE_DETECTION_SUBGRAPH_LAYER_HPP_
...
class DetectionSubgraphLayer : public Layer<Dtype> {
 public:
  explicit DetectionSubgraphLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
...
#endif  // CAFFE_DETECTION_SUBGRAPH_LAYER_HPP_
